...
- [x] Có đủ run, report, UI/transcript và 10 case nhóm. (Đã có run/report/UI/10 case; còn thiếu transcript thiếu-thông-tin, multi-turn và action/confirmation.)
- [x] Không sửa bộ câu cố định, không có key hoặc dữ liệu thật.
- [x] Repo mở được cho người chấm và từng thành viên đã nộp cùng URL trên VLearn. (Cần xác nhận thủ công trên GitHub và VLearn.)
